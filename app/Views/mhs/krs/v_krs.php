...
<tr>
  <th rowspan="7"><img src="<?= base_url('fotomhs/'. $mhs['foto_mhs'])?>"height="150px" width="120px"></th>
        ...
        <?php 
            ...
            <table class="table table-striped table-bordered table-responsive">
                ...
                <tr>
                    ...
                    <button class="btn btn-danger btn-xs btn-flat" data-toggle="modal" data-target="#delete<?= $value['id_krs']?>"><i class="fa fa-trash"></i></button>    
                    </td>
                </tr>
               <?php }?>
