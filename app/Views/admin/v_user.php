        ...
        <tbody>
            <?php $no= 1;
             foreach ($user as $key => $value) { ?>
                ...
                <td  class="text-center"><img src="<?= base_url('foto/'.$value['foto'])?>"class="img-circle" width="65px" height="65px"></td>
...
<div class="modal fade" id="edit<?= $value['id_user']?>">
          <div class="modal-dialog modal-sm">
            ...
            <div class="form-group">
              <img src="<?= base_url('foto/'.$value['foto'])?>" class="img-circle" width="100px" height="100px" alt="">
            </div>
